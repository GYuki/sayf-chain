...
HTTPS_GIT := https://github.com/sayf/sayf-chain.git
...
ifeq ($(LEDGER_ENABLED),true)
	...
	ifeq ($(UNAME_S),OpenBSD)
		$(warning OpenBSD detected, disabling ledger support (https://github.com/sayf/sayf-chain/issues/1988))
	else
...
ldflags = -X github.com/sayf/sayf-chain/version.Name=sim \
		-X github.com/sayf/sayf-chain/version.AppName=simd \
		-X github.com/sayf/sayf-chain/version.Version=$(VERSION) \
		-X github.com/sayf/sayf-chain/version.Commit=$(COMMIT) \
		-X "github.com/sayf/sayf-chain/version.BuildTags=$(build_tags_comma_sep)" \
...
godocs:
	@echo "--> Wait a few seconds and visit http://localhost:6060/pkg/github.com/sayf/sayf-chain/types"
